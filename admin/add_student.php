...
<div class="card-body">
  ...
  <div class="pt-4 pb-2">
    <h5 class="card-title text-center pb-0 fs-4">Add A Student</h5>
    <p class="text-center small">Enter the details to add a new student</p>
  </div>

  <form action="../inc/register.php" method="POST" class="row g-3 needs-validation" >
    <div class="col-12">
