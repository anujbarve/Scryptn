...
<head>
  ...
  <title>teachers / Profile - SCRYPTN Bootstrap Template</title>
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show profile-overview active pt-3" id="profile-overview">
                  <!-- Profile Edit Form -->
                    ...
                    <div class="row mb-3">
                      <label for="fullName" class="col-md-4 col-lg-3 col-form-label">teacher Name</label>
                      <div class="col-md-8 col-lg-9">
                        <?php echo $data["teacherUid"];?>
                      </div>
                    </div>
