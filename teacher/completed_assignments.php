                        ...
                        <div class="card-body">
                            ...
                            <table class="table datatable">
                                ...
                                <tbody>
                                    ...
                                    $query_file = "SELECT * FROM `completed_assignments`";
                                    ...
                                    if ($result_file->num_rows > 0) {
                                        while ($row = $result_file->fetch_assoc()) {
                                            ...
                                            echo "<td><a href='view_assignment.php?filename=" . $row['id'] . "'><button type='button' class='btn btn-success rounded-pill'>Open</button></a></td>";
                                            echo "</tr>";
                                        }
                                    } else {
                                        echo "0 results";
